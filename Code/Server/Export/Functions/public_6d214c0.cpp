...
CLANG_FORWARD_PROC_SYMBOL(public_6d214c0);
CLANG_FORWARD_PROC_SYMBOL(public_6d23ef0);
CLANG_FORWARD_JUMP_SYMBOL(public_6d62788);

PROC_DECLARE(0x6d214c0, internal_6d214c0, public_6d214c0);
extern "C" NAKED register_t __cdecl internal_6d214c0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6d62788 @0x6d214c2*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        pop edi
        mov dword ptr ds : [esi], offset public_6d68bf8
        mov eax, esi
        pop esi
        pop ebx
