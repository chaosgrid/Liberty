...
CLANG_FORWARD_PROC_SYMBOL(public_6d22980);
CLANG_FORWARD_PROC_SYMBOL(public_6d23ef0);
CLANG_FORWARD_JUMP_SYMBOL(public_6d62788);

PROC_DECLARE(0x6d22980, internal_6d22980, public_6d22980);
extern "C" NAKED register_t __cdecl internal_6d22980()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6d62788 @0x6d22982*/
  FIXUP push esp
  FIXUP push esp
