...
PROC_DECLARE(0x6ce2430, internal_6ce2430, public_6ce2430);
extern "C" NAKED register_t __cdecl internal_6ce2430()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax+8], offset public_6d64f10
        lea esi, ds:[edx+0xE0]
        lea edi, ds:[eax+0xE0]
        mov ecx, 9
        rep movsd
        ...
        mov dword ptr ds : [eax+0xD8], offset public_6d64f10
        ...
        mov dword ptr ds : [eax+0x1A8], offset public_6d64f10
        ...
        mov dword ptr ds : [eax], offset public_6d64f18
        pop esi
        ret 4
        UNREACHABLE_TRAP(0x6ce2430)
    }
}
