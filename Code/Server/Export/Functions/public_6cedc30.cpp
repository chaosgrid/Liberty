...
#define public_6cedcdb _public_6cedcdb
#define public_6cedcdd _public_6cedcdd
#define public_6cedd18 _public_6cedd18
#define public_6cedd70 _public_6cedd70

PROC_DECLARE(0x6cedc30, internal_6cedc30, public_6cedc30);
extern "C" NAKED register_t __cdecl internal_6cedc30()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6d60698 @0x6cedc32*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        call dword ptr ds : [public_6d64344]
        mov ebx, dword ptr ss : [esp+0x14]
        ...
        add esp, 0x68
        ret 4
        UNREACHABLE_TRAP(0x6cedc30)
    }
}

#undef public_6cedcdb
#undef public_6cedcdd
#undef public_6cedd18
#undef public_6cedd70
