...
CLANG_FORWARD_JUMP_SYMBOL(public_6d620e2);

#define public_6d1b419 _public_6d1b419

PROC_DECLARE(0x6d1b3a0, internal_6d1b3a0, public_6d1b3a0);
extern "C" NAKED register_t __cdecl internal_6d1b3a0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6d620e2 @0x6d1b3a2*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_6d620e2
...
/*FIXUP push offset public_6d727ac @0x6d1b469*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6d727ac
        ...
        call public_6d601a2
        UNREACHABLE_TRAP(0x6d1b3a0)
    }
}

#undef public_6d1b419
