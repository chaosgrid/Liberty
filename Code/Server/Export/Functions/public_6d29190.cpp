...
CLANG_FORWARD_PROC_SYMBOL(public_6d29190);
CLANG_FORWARD_JUMP_SYMBOL(public_6d62788);

PROC_DECLARE(0x6d29190, internal_6d29190, public_6d29190);
extern "C" NAKED register_t __cdecl internal_6d29190()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6d62788 @0x6d29192*/
  FIXUP push esp
  FIXUP push esp
