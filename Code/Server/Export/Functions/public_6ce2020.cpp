...
PROC_DECLARE(0x6ce2020, internal_6ce2020, public_6ce2020);
extern "C" NAKED register_t __cdecl internal_6ce2020()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax], offset public_6d64f10
        pop esi
        ret 4
        UNREACHABLE_TRAP(0x6ce2020)
    }
}
