...
CLANG_FORWARD_PROC_SYMBOL(public_6d22a20);
CLANG_FORWARD_JUMP_SYMBOL(public_6d62788);

PROC_DECLARE(0x6d22a20, internal_6d22a20, public_6d22a20);
extern "C" NAKED register_t __cdecl internal_6d22a20()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6d62788 @0x6d22a22*/
  FIXUP push esp
  FIXUP push esp
