...
CLANG_FORWARD_PROC_SYMBOL(public_6d217b0);
CLANG_FORWARD_PROC_SYMBOL(public_6d23ef0);
CLANG_FORWARD_JUMP_SYMBOL(public_6d62788);

PROC_DECLARE(0x6d217b0, internal_6d217b0, public_6d217b0);
extern "C" NAKED register_t __cdecl internal_6d217b0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6d62788 @0x6d217b2*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [esi+0x30], offset public_6d68e54
        pop edi
        mov dword ptr ds : [esi], offset public_6d68bc8
        mov eax, esi
        pop esi
        pop ebx
