...
CLANG_FORWARD_JUMP_SYMBOL(public_6d61d02);

#define public_6d16009 _public_6d16009

PROC_DECLARE(0x6d15f90, internal_6d15f90, public_6d15f90);
extern "C" NAKED register_t __cdecl internal_6d15f90()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6d61d02 @0x6d15f92*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_6d61d02
  ...
  FIXUP pop eax
        ...
        mov eax, dword ptr ds : [public_6d64ac8]
/*FIXUP push offset public_6d727ac @0x6d16059*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6d727ac
        ...
        call public_6d601a2
        UNREACHABLE_TRAP(0x6d15f90)
    }
}

#undef public_6d16009
