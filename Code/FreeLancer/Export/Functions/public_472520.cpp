...
PROC_DECLARE(0x472520, internal_472520, public_472520);
extern "C" NAKED register_t __cdecl internal_472520()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_5bbab1 @0x472522*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [edi], offset public_5d0620
