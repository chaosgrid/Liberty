...
#define public_5b49c0 _public_5b49c0
#define public_5b4a15 _public_5b4a15
#define public_5b4a17 _public_5b4a17
#define public_5b4a58 _public_5b4a58

PROC_DECLARE(0x5b49b0, internal_5b49b0, public_5b49b0);
extern "C" NAKED register_t __cdecl internal_5b49b0()
{
    __asm
    {
        mov ecx, offset public_67ecf7
        jmp public_5b49c0
        nop 
        nop 
        nop 
        ...
        push 0xFFFFFFFF
/*FIXUP push public_5c59d8 @0x5b49c8*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        cmp eax, esi
        je public_5b4a15
        mov dword ptr ds : [eax+4], offset public_5e703c
        ...
        mov dword ptr ds : [eax], offset public_5e7034
        mov dword ptr ds : [eax+8], 0x77A
        mov edi, eax
        jmp public_5b4a17
        public_5b4a15 : nop
        xor edi, edi
...
/*FIXUP push offset _public_5b3640 @0x5b4a40*/
  FIXUP push esp
