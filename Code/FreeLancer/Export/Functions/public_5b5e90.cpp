...
#define public_5b5ea0 _public_5b5ea0
#define public_5b5ef1 _public_5b5ef1
#define public_5b5ef3 _public_5b5ef3
#define public_5b5f34 _public_5b5f34

PROC_DECLARE(0x5b5e90, internal_5b5e90, public_5b5e90);
extern "C" NAKED register_t __cdecl internal_5b5e90()
{
    __asm
    {
        mov ecx, offset public_67ece6
        jmp public_5b5ea0
        nop 
        nop 
        nop 
        ...
        push 0xFFFFFFFF
/*FIXUP push public_5c59d8 @0x5b5ea8*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        cmp eax, esi
        je public_5b5ef1
        mov dword ptr ds : [eax+4], offset public_5e7130
        ...
        mov dword ptr ds : [eax], offset public_5e7128
        mov edi, eax
        jmp public_5b5ef3
        public_5b5ef1 : nop
        xor edi, edi
...
/*FIXUP push offset _public_5b3640 @0x5b5f1c*/
  FIXUP push esp
