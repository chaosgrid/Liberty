...
PROC_DECLARE(0x53fd80, internal_53fd80, public_53fd80);
extern "C" NAKED register_t __cdecl internal_53fd80()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax+8], offset public_5df894
        lea esi, ds:[edx+0xE0]
        lea edi, ds:[eax+0xE0]
        mov ecx, 9
        rep movsd
        ...
        mov dword ptr ds : [eax+0xD8], offset public_5df894
        ...
        mov dword ptr ds : [eax+0x1A8], offset public_5df894
        ...
        mov dword ptr ds : [eax], offset public_5df89c
        pop esi
        ret 4
        UNREACHABLE_TRAP(0x53fd80)
    }
}
