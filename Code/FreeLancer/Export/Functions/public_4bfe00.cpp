...
#define public_4bfeec _public_4bfeec

PROC_DECLARE(0x4bfe00, internal_4bfe00, public_4bfe00);
extern "C" NAKED register_t __cdecl internal_4bfe00()
{
    __asm
    {
        sub esp, 0x80
