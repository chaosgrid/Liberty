...
#define public_52a22a _public_52a22a
#define public_52a22c _public_52a22c

PROC_DECLARE(0x52a1b0, internal_52a1b0, public_52a1b0);
extern "C" NAKED register_t __cdecl internal_52a1b0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_5c03a3 @0x52a1b2*/
  FIXUP push esp
  FIXUP push esp
