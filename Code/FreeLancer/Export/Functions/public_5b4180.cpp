...
#define public_5b4190 _public_5b4190
#define public_5b41f6 _public_5b41f6
#define public_5b41f8 _public_5b41f8
#define public_5b4238 _public_5b4238

PROC_DECLARE(0x5b4180, internal_5b4180, public_5b4180);
extern "C" NAKED register_t __cdecl internal_5b4180()
{
    __asm
    {
        mov ecx, offset public_67ecfc
        jmp public_5b4190
        nop 
        nop 
        nop 
        ...
        push 0xFFFFFFFF
/*FIXUP push public_5c59d8 @0x5b4198*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov ecx, 1
        je public_5b41f6
        fld dword ptr ds : [public_5e6e00]
        mov dword ptr ds : [eax+4], offset public_5e6f88
        ...
        mov dword ptr ds : [eax], offset public_5e6f80
        mov dword ptr ds : [eax+8], 0x5C9
        mov edi, eax
        jmp public_5b41f8
        public_5b41f6 : nop
        xor edi, edi
        ...
        or dl, cl
        push 0xC
        mov byte ptr ds : [public_67ed0c], dl
        mov byte ptr ds : [public_67ed00], al
        call public_5b7e84
        mov dword ptr ds : [eax], eax
        mov dword ptr ds : [eax+4], eax
/*FIXUP push offset _public_5b3640 @0x5b4220*/
  FIXUP push esp
