...
#define public_40feab _public_40feab
#define public_40ff3c _public_40ff3c

PROC_DECLARE(0x40fd60, internal_40fd60, public_40fd60);
extern "C" NAKED register_t __cdecl internal_40fd60()
{
    __asm
    {
        sub esp, 0xC
