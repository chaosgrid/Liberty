...
#define public_5b4430 _public_5b4430
#define public_5b448c _public_5b448c
#define public_5b448e _public_5b448e
#define public_5b44cf _public_5b44cf

PROC_DECLARE(0x5b4420, internal_5b4420, public_5b4420);
extern "C" NAKED register_t __cdecl internal_5b4420()
{
    __asm
    {
        mov ecx, offset public_67ecfa
        jmp public_5b4430
        nop 
        nop 
        nop 
        ...
        push 0xFFFFFFFF
/*FIXUP push public_5c59d8 @0x5b4438*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        cmp eax, esi
        je public_5b448c
        mov dword ptr ds : [eax+4], offset public_5e6fc8
        ...
        mov dword ptr ds : [eax], offset public_5e6fc0
        mov dword ptr ds : [eax+0x1C], offset public_5e6fb8
        mov dword ptr ds : [eax+8], 0x5D5
        mov edi, eax
        jmp public_5b448e
        public_5b448c : nop
        xor edi, edi
...
/*FIXUP push offset _public_5b3640 @0x5b44b7*/
  FIXUP push esp
