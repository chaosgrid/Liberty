...
#define public_66ff4e2 _public_66ff4e2
#define public_66ff527 _public_66ff527
#define public_66ff5d1 _public_66ff5d1

PROC_DECLARE(0x66ff460, internal_66ff460, public_66ff460);
extern "C" NAKED register_t __cdecl internal_66ff460()
{
    __asm
    {
        ...
        pop esi
        ret 0xC
        UNREACHABLE_TRAP(0x66ff460)
    }
}

#undef public_66ff4e2
#undef public_66ff527
#undef public_66ff5d1
