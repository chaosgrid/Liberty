...
#define public_52a3e6 _public_52a3e6
#define public_52a3e8 _public_52a3e8

PROC_DECLARE(0x52a360, internal_52a360, public_52a360);
extern "C" NAKED register_t __cdecl internal_52a360()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_5c03a3 @0x52a362*/
  FIXUP push esp
  FIXUP push esp
