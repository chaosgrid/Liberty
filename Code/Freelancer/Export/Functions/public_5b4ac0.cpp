...
#define public_5b4ad0 _public_5b4ad0
#define public_5b4b25 _public_5b4b25
#define public_5b4b27 _public_5b4b27
#define public_5b4b68 _public_5b4b68

PROC_DECLARE(0x5b4ac0, internal_5b4ac0, public_5b4ac0);
extern "C" NAKED register_t __cdecl internal_5b4ac0()
{
    __asm
    {
        mov ecx, offset public_67ecf6
        jmp public_5b4ad0
        nop 
        nop 
        nop 
        ...
        push 0xFFFFFFFF
/*FIXUP push public_5c59d8 @0x5b4ad8*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        cmp eax, esi
        je public_5b4b25
        mov dword ptr ds : [eax+4], offset public_5e7060
        ...
        mov dword ptr ds : [eax], offset public_5e7058
        mov dword ptr ds : [eax+8], 0x77B
        mov edi, eax
        jmp public_5b4b27
        public_5b4b25 : nop
        xor edi, edi
...
/*FIXUP push offset _public_5b3640 @0x5b4b50*/
  FIXUP push esp
