...
#define public_53faf0 _public_53faf0
#define public_53fb20 _public_53fb20

PROC_DECLARE(0x53fad0, internal_53fad0, public_53fad0);
extern "C" NAKED register_t __cdecl internal_53fad0()
{
    __asm
    {
        push ebp
