...
#define public_6acbf05 _public_6acbf05

PROC_DECLARE(0x6acbedd, internal_6acbedd, public_6acbedd);
extern "C" NAKED register_t __cdecl internal_6acbedd()
{
    __asm
    {
        push esi
        ...
        pop esi
        ret 8
        UNREACHABLE_TRAP(0x6acbedd)
    }
}

#undef public_6acbf05
