...
PROC_DECLARE(0x6711d10, internal_6711d10, public_6711d10);
extern "C" NAKED register_t __cdecl internal_6711d10()
{
    __asm
    {
        ...
        mov dword ptr ds : [eax], offset public_67171b4
        mov dword ptr ds : [eax+0x90], edx
        pop esi
        ret 4
        UNREACHABLE_TRAP(0x6711d10)
    }
}
