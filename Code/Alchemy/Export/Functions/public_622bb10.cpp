...
CLANG_FORWARD_JUMP_SYMBOL(public_6249488);

PROC_DECLARE(0x622bb10, internal_622bb10, public_622bb10);
extern "C" NAKED register_t __cdecl internal_622bb10()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6249488 @0x622bb12*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_6249488
