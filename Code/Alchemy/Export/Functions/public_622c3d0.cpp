...
#define public_622c410 _public_622c410
#define public_622c444 _public_622c444
#define public_622c4bb _public_622c4bb
#define public_622c4cc _public_622c4cc

PROC_DECLARE(0x622c3d0, internal_622c3d0, public_622c3d0);
extern "C" NAKED register_t __cdecl internal_622c3d0()
{
    __asm
    {
        ...
        sub esp, 8
        xor eax, eax
        mov word ptr ds : [public_6257a7e], ax
        mov word ptr ds : [public_6257a80], ax
        push ebx
        push esi
        ...
        add esp, 8
        ret 8
        UNREACHABLE_TRAP(0x622c3d0)
    }
}

#undef public_622c410
#undef public_622c444
#undef public_622c4bb
#undef public_622c4cc
