...
CLANG_FORWARD_JUMP_SYMBOL(public_62487a1);

#define public_621b983 _public_621b983
#define public_621b985 _public_621b985

PROC_DECLARE(0x621b890, internal_621b890, public_621b890);
extern "C" NAKED register_t __cdecl internal_621b890()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_62487a1 @0x621b892*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_62487a1
  ...
  FIXUP pop eax
        ...
        mov dword ptr ss : [ebp], offset public_624d320
        mov dword ptr ss : [ebp+4], offset public_624d2c8
        mov dword ptr ss : [ebp+0x108], 1
        pop ebx
        jmp public_621b985
        public_621b983 : nop
        xor ebp, ebp
        ...
        add esp, 0x14
        ret 8
        UNREACHABLE_TRAP(0x621b890)
    }
}

#undef public_621b983
#undef public_621b985
