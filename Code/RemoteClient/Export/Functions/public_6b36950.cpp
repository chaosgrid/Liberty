...
#define public_6b369d9 _public_6b369d9

PROC_DECLARE(0x6b36950, internal_6b36950, public_6b36950);
extern "C" NAKED register_t __cdecl internal_6b36950()
{
    __asm
    {
        push ecx
        ...
        pop ecx
        ret 8
        UNREACHABLE_TRAP(0x6b36950)
    }
}

#undef public_6b369d9
