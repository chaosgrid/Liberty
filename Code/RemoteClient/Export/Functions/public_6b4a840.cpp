...
CLANG_FORWARD_JUMP_SYMBOL(public_6b6aa0a);

PROC_DECLARE(0x6b4a840, internal_6b4a840, public_6b4a840);
extern "C" NAKED register_t __cdecl internal_6b4a840()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6b6aa0a @0x6b4a842*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_6b6aa0a
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [esi], offset public_6b6c1cc
