...
PROC_DECLARE(0x6b4aca0, internal_6b4aca0, public_6b4aca0);
extern "C" NAKED register_t __cdecl internal_6b4aca0()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax], offset public_6b6da04
        mov dword ptr ds : [eax+0xC], 0x2004E
        ret 
        UNREACHABLE_TRAP(0x6b4aca0)
    }
}
