...
PROC_DECLARE(0x6b4a9e0, internal_6b4a9e0, public_6b4a9e0);
extern "C" NAKED register_t __cdecl internal_6b4a9e0()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax], offset public_6b6d9d4
        mov dword ptr ds : [eax+0xC], 0x2002C
        ret 
        UNREACHABLE_TRAP(0x6b4a9e0)
    }
}
