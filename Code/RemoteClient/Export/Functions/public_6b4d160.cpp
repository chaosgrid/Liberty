...
PROC_DECLARE(0x6b4d160, internal_6b4d160, public_6b4d160);
extern "C" NAKED register_t __cdecl internal_6b4d160()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax], offset public_6b6dc84
        mov dword ptr ds : [eax+0xC], 0x20055
        ret 
        UNREACHABLE_TRAP(0x6b4d160)
    }
}
