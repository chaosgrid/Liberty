...
#define public_6ee635a _public_6ee635a
#define public_6ee6378 _public_6ee6378
#define public_6ee6390 _public_6ee6390
#define public_6ee63b6 _public_6ee63b6
#define public_6ee63d6 _public_6ee63d6
#define public_6ee6446 _public_6ee6446
#define public_6ee6449 _public_6ee6449

PROC_DECLARE(0x6ee6280, internal_6ee6280, public_6ee6280);
extern "C" NAKED register_t __cdecl internal_6ee6280()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fab44b @0x6ee6282*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [ebx], offset public_6fb7378
        ...
        push eax
/*FIXUP push offset public_6fb6064 @0x6ee63fc*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6064
        ...
        add esp, 0xE8
        ret 0xC
        UNREACHABLE_TRAP(0x6ee6280)
    }
}

#undef public_6ee635a
#undef public_6ee6378
#undef public_6ee6390
#undef public_6ee63b6
#undef public_6ee63d6
#undef public_6ee6446
#undef public_6ee6449
