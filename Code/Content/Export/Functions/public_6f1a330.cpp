...
#define public_6f1a3c4 _public_6f1a3c4

PROC_DECLARE(0x6f1a330, internal_6f1a330, public_6f1a330);
extern "C" NAKED register_t __cdecl internal_6f1a330()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fadc4b @0x6f1a332*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov ecx, 5
        rep movsd
        mov dword ptr ds : [ebx], offset public_6fb8c78
        mov eax, ebx
        pop edi
        public_6f1a3c4 : nop
        ...
        add esp, 0x10
        ret 
        UNREACHABLE_TRAP(0x6f1a330)
    }
}

#undef public_6f1a3c4
