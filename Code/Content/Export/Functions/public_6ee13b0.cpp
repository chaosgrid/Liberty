...
CLANG_FORWARD_PROC_SYMBOL(public_6ee13b0);
...
#define public_6ee148a _public_6ee148a
#define public_6ee14a8 _public_6ee14a8
#define public_6ee14c0 _public_6ee14c0
#define public_6ee14e6 _public_6ee14e6
#define public_6ee1506 _public_6ee1506
#define public_6ee1576 _public_6ee1576
#define public_6ee1579 _public_6ee1579

PROC_DECLARE(0x6ee13b0, internal_6ee13b0, public_6ee13b0);
extern "C" NAKED register_t __cdecl internal_6ee13b0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fab44b @0x6ee13b2*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [ebx], offset public_6fb721c
        ...
        push eax
/*FIXUP push offset public_6fb6064 @0x6ee152c*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6064
        ...
        add esp, 0xE8
        ret 0xC
        UNREACHABLE_TRAP(0x6ee13b0)
    }
}

#undef public_6ee148a
#undef public_6ee14a8
#undef public_6ee14c0
#undef public_6ee14e6
#undef public_6ee1506
#undef public_6ee1576
#undef public_6ee1579
