...
CLANG_FORWARD_PROC_SYMBOL(public_6ee11c0);
...
#define public_6ee129a _public_6ee129a
#define public_6ee12b8 _public_6ee12b8
#define public_6ee12d0 _public_6ee12d0
#define public_6ee12f6 _public_6ee12f6
#define public_6ee1316 _public_6ee1316
#define public_6ee1386 _public_6ee1386
#define public_6ee1389 _public_6ee1389

PROC_DECLARE(0x6ee11c0, internal_6ee11c0, public_6ee11c0);
extern "C" NAKED register_t __cdecl internal_6ee11c0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fab44b @0x6ee11c2*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [ebx], offset public_6fb71f0
        ...
        push eax
/*FIXUP push offset public_6fb6064 @0x6ee133c*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6064
        ...
        add esp, 0xE8
        ret 0xC
        UNREACHABLE_TRAP(0x6ee11c0)
    }
}

#undef public_6ee129a
#undef public_6ee12b8
#undef public_6ee12d0
#undef public_6ee12f6
#undef public_6ee1316
#undef public_6ee1386
#undef public_6ee1389
