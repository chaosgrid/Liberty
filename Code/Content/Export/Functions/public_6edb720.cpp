...
CLANG_FORWARD_PROC_SYMBOL(public_6edb720);
...
#define public_6edb80e _public_6edb80e
#define public_6edb85b _public_6edb85b
#define public_6edb8f3 _public_6edb8f3
#define public_6edba13 _public_6edba13
#define public_6edba21 _public_6edba21
#define public_6edba2f _public_6edba2f
#define public_6edba68 _public_6edba68
#define public_6edba6b _public_6edba6b

PROC_DECLARE(0x6edb720, internal_6edb720, public_6edb720);
extern "C" NAKED register_t __cdecl internal_6edb720()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fab376 @0x6edb722*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [ebx], offset public_6fb69a8
        ...
        call public_6eec8d0
/*FIXUP push offset public_6fb6994 @0x6edb8ab*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6994
        lea eax, ss:[esp+0xA0]
        push 0x40
        push eax
...
/*FIXUP public_6edb8f3 : nop
        push offset public_6fb572c @0x6edb8f3*/
  FIXUP public_6edb8f3 : nop
        push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb572c
        ...
        push ecx
        lea edx, ss:[esp+0x60]
/*FIXUP push offset public_6fb6838 @0x6edb905*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6838
        ...
        rep movsd
/*FIXUP push offset public_6fb62ec @0x6edb926*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb62ec
        ...
        call public_6eeb110
        add esp, 8
/*FIXUP public_6edba21 : nop
        push offset public_6fb6064 @0x6edba21*/
  FIXUP public_6edba21 : nop
        push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6064
        ...
        add esp, 0x1A4
        ret 0xC
        UNREACHABLE_TRAP(0x6edb720)
    }
}

#undef public_6edb80e
#undef public_6edb85b
#undef public_6edb8f3
#undef public_6edba13
#undef public_6edba21
#undef public_6edba2f
#undef public_6edba68
#undef public_6edba6b
