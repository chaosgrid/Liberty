...
CLANG_FORWARD_PROC_SYMBOL(public_6eddc10);
...
#define public_6eddcea _public_6eddcea
#define public_6eddd08 _public_6eddd08
#define public_6eddd20 _public_6eddd20
#define public_6eddd46 _public_6eddd46
#define public_6eddd66 _public_6eddd66
#define public_6edddd6 _public_6edddd6
#define public_6edddd9 _public_6edddd9

PROC_DECLARE(0x6eddc10, internal_6eddc10, public_6eddc10);
extern "C" NAKED register_t __cdecl internal_6eddc10()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fab44b @0x6eddc12*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [ebx], offset public_6fb6d1c
        ...
        push eax
/*FIXUP push offset public_6fb6064 @0x6eddd8c*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6064
        ...
        add esp, 0xE8
        ret 0xC
        UNREACHABLE_TRAP(0x6eddc10)
    }
}

#undef public_6eddcea
#undef public_6eddd08
#undef public_6eddd20
#undef public_6eddd46
#undef public_6eddd66
#undef public_6edddd6
#undef public_6edddd9
