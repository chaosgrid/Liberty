...
CLANG_FORWARD_PROC_SYMBOL(public_6ee06d0);
...
#define public_6ee07ad _public_6ee07ad
#define public_6ee07d0 _public_6ee07d0
#define public_6ee07e8 _public_6ee07e8
#define public_6ee080e _public_6ee080e
#define public_6ee082e _public_6ee082e
#define public_6ee089e _public_6ee089e
#define public_6ee08a1 _public_6ee08a1

PROC_DECLARE(0x6ee06d0, internal_6ee06d0, public_6ee06d0);
extern "C" NAKED register_t __cdecl internal_6ee06d0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fab44b @0x6ee06d2*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [ebx], offset public_6fb7154
        ...
        push eax
/*FIXUP push offset public_6fb6064 @0x6ee0854*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6064
        ...
        add esp, 0xE8
        ret 0xC
        UNREACHABLE_TRAP(0x6ee06d0)
    }
}

#undef public_6ee07ad
#undef public_6ee07d0
#undef public_6ee07e8
#undef public_6ee080e
#undef public_6ee082e
#undef public_6ee089e
#undef public_6ee08a1
