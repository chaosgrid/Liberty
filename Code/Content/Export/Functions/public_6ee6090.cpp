...
#define public_6ee6188 _public_6ee6188
#define public_6ee61a0 _public_6ee61a0
#define public_6ee61c6 _public_6ee61c6
#define public_6ee61e6 _public_6ee61e6
#define public_6ee6256 _public_6ee6256
#define public_6ee6259 _public_6ee6259

PROC_DECLARE(0x6ee6090, internal_6ee6090, public_6ee6090);
extern "C" NAKED register_t __cdecl internal_6ee6090()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fab44b @0x6ee6092*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [ebx], offset public_6fb7350
        ...
        push eax
/*FIXUP push offset public_6fb6064 @0x6ee620c*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6064
        ...
        add esp, 0xE8
        ret 0xC
        UNREACHABLE_TRAP(0x6ee6090)
    }
}

#undef public_6ee616a
#undef public_6ee6188
#undef public_6ee61a0
#undef public_6ee61c6
#undef public_6ee61e6
#undef public_6ee6256
#undef public_6ee6259
