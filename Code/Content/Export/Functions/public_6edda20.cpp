...
CLANG_FORWARD_PROC_SYMBOL(public_6edda20);
...
#define public_6eddafa _public_6eddafa
#define public_6eddb38 _public_6eddb38
#define public_6eddbbe _public_6eddbbe
#define public_6eddbc3 _public_6eddbc3
#define public_6eddbe0 _public_6eddbe0
#define public_6eddbe2 _public_6eddbe2
#define public_6eddbe5 _public_6eddbe5

PROC_DECLARE(0x6edda20, internal_6edda20, public_6edda20);
extern "C" NAKED register_t __cdecl internal_6edda20()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fab44b @0x6edda22*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [ebx], offset public_6fb6cf0
        ...
        mov dword ptr ss : [ebp+4], edi
/*FIXUP public_6eddb38 : nop
        push offset public_6fb6cd8 @0x6eddb38*/
  FIXUP public_6eddb38 : nop
        push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6cd8
        lea ecx, ss:[esp+0x28]
        push 0x40
        push ecx
...
/*FIXUP push offset public_6fb62ec @0x6eddb5d*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb62ec
        ...
        jne public_6eddbbe
/*FIXUP push offset public_6fb6cb0 @0x6eddbb7*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6cb0
        jmp public_6eddbc3
/*FIXUP public_6eddbbe : nop
        push offset public_6fb6c88 @0x6eddbbe*/
  FIXUP public_6eddbbe : nop
        push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6c88
        ...
        add esp, 0xE8
        ret 0x10
        UNREACHABLE_TRAP(0x6edda20)
    }
}

#undef public_6eddafa
#undef public_6eddb38
#undef public_6eddbbe
#undef public_6eddbc3
#undef public_6eddbe0
#undef public_6eddbe2
#undef public_6eddbe5
