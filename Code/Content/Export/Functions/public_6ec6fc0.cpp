...
CLANG_FORWARD_PROC_SYMBOL(public_6ec6fc0);

#define public_6ec702b _public_6ec702b

PROC_DECLARE(0x6ec6fc0, internal_6ec6fc0, public_6ec6fc0);
extern "C" NAKED register_t __cdecl internal_6ec6fc0()
{
    __asm
    {
        ...
        mov dword ptr ds : [ebx], offset public_6fb5b80
        repne scasb
        not ecx
        dec ecx
        mov eax, ecx
        ...
        pop ebx
        ret 4
        UNREACHABLE_TRAP(0x6ec6fc0)
    }
}

#undef public_6ec702b
