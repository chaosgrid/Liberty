...
CLANG_FORWARD_PROC_SYMBOL(public_6ed8f10);
...
#define public_6ed8fed _public_6ed8fed
#define public_6ed9010 _public_6ed9010
#define public_6ed9028 _public_6ed9028
#define public_6ed904e _public_6ed904e
#define public_6ed906e _public_6ed906e
#define public_6ed90de _public_6ed90de
#define public_6ed90e1 _public_6ed90e1

PROC_DECLARE(0x6ed8f10, internal_6ed8f10, public_6ed8f10);
extern "C" NAKED register_t __cdecl internal_6ed8f10()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fab44b @0x6ed8f12*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [ebx], offset public_6fb6624
        ...
        push eax
/*FIXUP push offset public_6fb6064 @0x6ed9094*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6064
        ...
        add esp, 0xE8
        ret 0xC
        UNREACHABLE_TRAP(0x6ed8f10)
    }
}

#undef public_6ed8fed
#undef public_6ed9010
#undef public_6ed9028
#undef public_6ed904e
#undef public_6ed906e
#undef public_6ed90de
#undef public_6ed90e1
