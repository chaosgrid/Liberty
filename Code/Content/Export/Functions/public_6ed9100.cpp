...
CLANG_FORWARD_PROC_SYMBOL(public_6ed9100);
...
#define public_6ed91dd _public_6ed91dd
#define public_6ed921b _public_6ed921b
#define public_6ed9304 _public_6ed9304
#define public_6ed9306 _public_6ed9306
#define public_6ed9309 _public_6ed9309

PROC_DECLARE(0x6ed9100, internal_6ed9100, public_6ed9100);
extern "C" NAKED register_t __cdecl internal_6ed9100()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fab42b @0x6ed9102*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [ebx], offset public_6fb6670
        ...
        mov dword ptr ss : [ebp+4], edi
/*FIXUP public_6ed921b : nop
        push offset public_6fb6654 @0x6ed921b*/
  FIXUP public_6ed921b : nop
        push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6654
        lea ecx, ss:[esp+0x24]
        push 0x40
        push ecx
...
/*FIXUP push offset public_6fb6064 @0x6ed9240*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6064
        ...
        mov ecx, ebp
        call public_6f937c0
/*FIXUP push offset public_6fb6638 @0x6ed928e*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6638
        lea edx, ss:[esp+0x68]
        push 0x40
        push edx
        ...
        push eax
/*FIXUP push offset public_6fb6064 @0x6ed92b4*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6064
        lea ecx, ss:[esp+0x78]
        push ecx
        ...
        add esp, 0x16C
        ret 0xC
        UNREACHABLE_TRAP(0x6ed9100)
    }
}

#undef public_6ed91dd
#undef public_6ed921b
#undef public_6ed9304
#undef public_6ed9306
#undef public_6ed9309
