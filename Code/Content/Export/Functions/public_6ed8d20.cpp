...
CLANG_FORWARD_PROC_SYMBOL(public_6ed8d20);
...
#define public_6ed8dfd _public_6ed8dfd
#define public_6ed8e20 _public_6ed8e20
#define public_6ed8e38 _public_6ed8e38
#define public_6ed8e5e _public_6ed8e5e
#define public_6ed8e7e _public_6ed8e7e
#define public_6ed8eee _public_6ed8eee
#define public_6ed8ef1 _public_6ed8ef1

PROC_DECLARE(0x6ed8d20, internal_6ed8d20, public_6ed8d20);
extern "C" NAKED register_t __cdecl internal_6ed8d20()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fab44b @0x6ed8d22*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [ebx], offset public_6fb65f0
        ...
        push eax
/*FIXUP push offset public_6fb6064 @0x6ed8ea4*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6064
        ...
        add esp, 0xE8
        ret 0xC
        UNREACHABLE_TRAP(0x6ed8d20)
    }
}

#undef public_6ed8dfd
#undef public_6ed8e20
#undef public_6ed8e38
#undef public_6ed8e5e
#undef public_6ed8e7e
#undef public_6ed8eee
#undef public_6ed8ef1
