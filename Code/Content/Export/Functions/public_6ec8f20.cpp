...
CLANG_FORWARD_PROC_SYMBOL(public_6ec8f20);
...
extern "C" NAKED register_t __cdecl internal_6ec8f20()
{
    ...
    {
        push 0xFFFFFFFF
/*FIXUP push public_6faaea8 @0x6ec8f22*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        call ebp
/*FIXUP push offset public_6fb572c @0x6ec8f66*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb572c
        mov dword ptr ds : [esi], offset public_6fb5c94
