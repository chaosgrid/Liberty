...
CLANG_FORWARD_PROC_SYMBOL(public_6ec73f0);

PROC_DECLARE(0x6ec73f0, internal_6ec73f0, public_6ec73f0);
extern "C" NAKED register_t __cdecl internal_6ec73f0()
{
    __asm
    {
        ...
        mov dword ptr ds : [esi], offset public_6fb5b98
        mov eax, esi
        pop esi
        ret 4
        UNREACHABLE_TRAP(0x6ec73f0)
    }
}
