...
CLANG_FORWARD_PROC_SYMBOL(public_6ece060);

#define public_6ece0cb _public_6ece0cb

PROC_DECLARE(0x6ece060, internal_6ece060, public_6ece060);
extern "C" NAKED register_t __cdecl internal_6ece060()
{
    __asm
    {
        ...
        mov dword ptr ds : [ebx], offset public_6fb5fd4
        repne scasb
        not ecx
        dec ecx
        mov eax, ecx
        ...
        pop ebx
        ret 4
        UNREACHABLE_TRAP(0x6ece060)
    }
}

#undef public_6ece0cb
