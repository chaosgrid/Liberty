...
#define public_6f27378 _public_6f27378
#define public_6f27396 _public_6f27396
#define public_6f273ad _public_6f273ad
#define public_6f273e0 _public_6f273e0

PROC_DECLARE(0x6f27340, internal_6f27340, public_6f27340);
extern "C" NAKED register_t __cdecl internal_6f27340()
{
    __asm
    {
        push ebx
        ...
        mov edi, eax
        public_6f27378 : nop
        mov dword ptr ds : [ebx+0x150], edi
        test edi, 0x3FFFFFFF
        pop edi
        jne public_6f27396
        mov ecx, esi
        ...
        mov ecx, esi
        call public_6f57c80
        mov dword ptr ds : [ebx+0x14C], eax
        public_6f273ad : nop
        ...
        pop ebx
        ret 4
        UNREACHABLE_TRAP(0x6f27340)
    }
}

#undef public_6f27378
#undef public_6f27396
#undef public_6f273ad
#undef public_6f273e0
