...
CLANG_FORWARD_PROC_SYMBOL(public_6ee08c0);
...
#define public_6ee099d _public_6ee099d
#define public_6ee09c0 _public_6ee09c0
#define public_6ee09d8 _public_6ee09d8
#define public_6ee09fe _public_6ee09fe
#define public_6ee0a1e _public_6ee0a1e
#define public_6ee0a8e _public_6ee0a8e
#define public_6ee0a91 _public_6ee0a91

PROC_DECLARE(0x6ee08c0, internal_6ee08c0, public_6ee08c0);
extern "C" NAKED register_t __cdecl internal_6ee08c0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fab44b @0x6ee08c2*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [ebx], offset public_6fb7180
        ...
        push eax
/*FIXUP push offset public_6fb6064 @0x6ee0a44*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6064
        ...
        add esp, 0xE8
        ret 0xC
        UNREACHABLE_TRAP(0x6ee08c0)
    }
}

#undef public_6ee099d
#undef public_6ee09c0
#undef public_6ee09d8
#undef public_6ee09fe
#undef public_6ee0a1e
#undef public_6ee0a8e
#undef public_6ee0a91
