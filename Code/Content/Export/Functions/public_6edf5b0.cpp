...
CLANG_FORWARD_PROC_SYMBOL(public_6edf5b0);
...
#define public_6edf68d _public_6edf68d
#define public_6edf6b0 _public_6edf6b0
#define public_6edf6c8 _public_6edf6c8
#define public_6edf6ee _public_6edf6ee
#define public_6edf70e _public_6edf70e
#define public_6edf77e _public_6edf77e
#define public_6edf781 _public_6edf781

PROC_DECLARE(0x6edf5b0, internal_6edf5b0, public_6edf5b0);
extern "C" NAKED register_t __cdecl internal_6edf5b0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fab44b @0x6edf5b2*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [ebx], offset public_6fb6f8c
        ...
        push eax
/*FIXUP push offset public_6fb6064 @0x6edf734*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6064
        ...
        add esp, 0xE8
        ret 0xC
        UNREACHABLE_TRAP(0x6edf5b0)
    }
}

#undef public_6edf68d
#undef public_6edf6b0
#undef public_6edf6c8
#undef public_6edf6ee
#undef public_6edf70e
#undef public_6edf77e
#undef public_6edf781
