...
CLANG_FORWARD_PROC_SYMBOL(public_6f712e0);
CLANG_FORWARD_JUMP_SYMBOL(public_6fafea9);

PROC_DECLARE(0x6f712e0, internal_6f712e0, public_6f712e0);
extern "C" NAKED register_t __cdecl internal_6f712e0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fafea9 @0x6f712e2*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [edi], offset public_6fbbe18
        mov dword ptr ds : [esi+0x50], ecx
        mov ecx, dword ptr ss : [esp+0x10]
        pop edi
        mov dword ptr ds : [esi+0x54], edx
        mov dword ptr ds : [esi], offset public_6fbbdec
        mov eax, esi
        pop esi
        pop ebx
