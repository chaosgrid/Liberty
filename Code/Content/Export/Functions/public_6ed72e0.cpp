...
CLANG_FORWARD_PROC_SYMBOL(public_6ed72e0);
...
#define public_6ed73ba _public_6ed73ba
#define public_6ed73d8 _public_6ed73d8
#define public_6ed73f0 _public_6ed73f0
#define public_6ed7416 _public_6ed7416
#define public_6ed7436 _public_6ed7436
#define public_6ed74a6 _public_6ed74a6
#define public_6ed74a9 _public_6ed74a9

PROC_DECLARE(0x6ed72e0, internal_6ed72e0, public_6ed72e0);
extern "C" NAKED register_t __cdecl internal_6ed72e0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6fab44b @0x6ed72e2*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [ebx], offset public_6fb6390
        ...
        push eax
/*FIXUP push offset public_6fb6064 @0x6ed745c*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb6064
        ...
        add esp, 0xE8
        ret 0xC
        UNREACHABLE_TRAP(0x6ed72e0)
    }
}

#undef public_6ed73ba
#undef public_6ed73d8
#undef public_6ed73f0
#undef public_6ed7416
#undef public_6ed7436
#undef public_6ed74a6
#undef public_6ed74a9
