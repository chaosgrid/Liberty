...
CLANG_FORWARD_JUMP_SYMBOL(public_6fa972a);

#define public_6ea4c73 _public_6ea4c73
#define public_6ea4c84 _public_6ea4c84
#define public_6ea4c99 _public_6ea4c99
#define public_6ea4cbf _public_6ea4cbf
#define public_6ea4ce4 _public_6ea4ce4
#define public_6ea4ced _public_6ea4ced
#define public_6ea4d41 _public_6ea4d41
#define public_6ea4d4c _public_6ea4d4c
#define public_6ea4d5b _public_6ea4d5b
#define public_6ea4d71 _public_6ea4d71
#define public_6ea4d91 _public_6ea4d91
#define public_6ea4d9a _public_6ea4d9a

PROC_DECLARE(0x6ea4b60, internal_6ea4b60, public_6ea4b60);
extern "C" NAKED register_t __cdecl internal_6ea4b60()
{
    __asm
    {
        mov eax, dword ptr fs : [0]
        push 0xFFFFFFFF
/*FIXUP push public_6fa972a @0x6ea4b68*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_6fa972a
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [esi], offset public_6fb3fb8
        mov dword ptr ds : [esi+0x2B4], 0x1F
        mov dword ptr ds : [esi+0x2B8], 0x20
        mov dword ptr ds : [esi+0x2C0], 0x5CF8
        mov dword ptr ds : [esi+0x2C4], 0x80E8
        call dword ptr ds : [public_6fb300c]
        lea edx, ss:[esp+0x14]
        push edx
/*FIXUP push offset public_6fb3fa0 @0x6ea4be5*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_6fb3fa0
        ...
        add esp, 0x157C
        ret 8
        UNREACHABLE_TRAP(0x6ea4b60)
    }
}

#undef public_6ea4c73
#undef public_6ea4c84
#undef public_6ea4c99
#undef public_6ea4cbf
#undef public_6ea4ce4
#undef public_6ea4ced
#undef public_6ea4d41
#undef public_6ea4d4c
#undef public_6ea4d5b
#undef public_6ea4d71
#undef public_6ea4d91
#undef public_6ea4d9a
