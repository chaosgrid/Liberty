...
PROC_DECLARE(0x409ec0, internal_409ec0, public_409ec0);
extern "C" NAKED register_t __cdecl internal_409ec0()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax+8], offset public_41d024
        lea esi, ds:[edx+0xE0]
        lea edi, ds:[eax+0xE0]
        mov ecx, 9
        rep movsd
        ...
        mov dword ptr ds : [eax+0xD8], offset public_41d024
        ...
        mov dword ptr ds : [eax+0x1A8], offset public_41d024
        ...
        mov dword ptr ds : [eax], offset public_41d028
        pop esi
        ret 4
        UNREACHABLE_TRAP(0x409ec0)
    }
}
