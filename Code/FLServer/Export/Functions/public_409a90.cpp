...
PROC_DECLARE(0x409a90, internal_409a90, public_409a90);
extern "C" NAKED register_t __cdecl internal_409a90()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax], offset public_41d024
        pop esi
        ret 4
        UNREACHABLE_TRAP(0x409a90)
    }
}
