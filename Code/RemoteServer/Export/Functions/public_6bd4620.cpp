...
CLANG_FORWARD_PROC_SYMBOL(public_6bd4620);

PROC_DECLARE(0x6bd4620, internal_6bd4620, public_6bd4620);
extern "C" NAKED register_t __cdecl internal_6bd4620()
{
    __asm
    {
        mov eax, ecx
