...
CLANG_FORWARD_PROC_SYMBOL(public_6be7410);
CLANG_FORWARD_JUMP_SYMBOL(public_6c0a7ca);

PROC_DECLARE(0x6be7410, internal_6be7410, public_6be7410);
extern "C" NAKED register_t __cdecl internal_6be7410()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6c0a7ca @0x6be7412*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_6c0a7ca
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [esi], offset public_6c0cc18
