...
CLANG_FORWARD_PROC_SYMBOL(public_6bd3f20);
CLANG_FORWARD_PROC_SYMBOL(public_6c09d26);
CLANG_FORWARD_JUMP_SYMBOL(public_6c0a0db);

PROC_DECLARE(0x6bd3f20, internal_6bd3f20, public_6bd3f20);
extern "C" NAKED register_t __cdecl internal_6bd3f20()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6c0a0db @0x6bd3f22*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_6c0a0db
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [esi], offset public_6c0b7a0
        mov eax, esi
        pop esi
        pop ebx
