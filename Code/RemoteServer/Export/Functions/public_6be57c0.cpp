...
PROC_DECLARE(0x6be57c0, internal_6be57c0, public_6be57c0);
extern "C" NAKED register_t __cdecl internal_6be57c0()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax], offset public_6c0c9a8
        mov dword ptr ds : [eax+0xC], 0x2004E
        ret 
        UNREACHABLE_TRAP(0x6be57c0)
    }
}
