...
PROC_DECLARE(0x6be91c0, internal_6be91c0, public_6be91c0);
extern "C" NAKED register_t __cdecl internal_6be91c0()
{
    __asm
    {
        push ecx
        ...
        mov dword ptr ds : [eax], offset public_6c0d128
        mov dword ptr ds : [eax+0xC], 0x1001D
        pop ecx
        ret 
        UNREACHABLE_TRAP(0x6be91c0)
    }
}
