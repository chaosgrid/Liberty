...
PROC_DECLARE(0x6beb660, internal_6beb660, public_6beb660);
extern "C" NAKED register_t __cdecl internal_6beb660()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax], offset public_6c0db10
        mov dword ptr ds : [eax+0xC], 0x30022
        ret 
        UNREACHABLE_TRAP(0x6beb660)
    }
}
