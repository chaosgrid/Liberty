...
PROC_DECLARE(0x6d9d5b0, internal_6d9d5b0, public_6d9d5b0);
extern "C" NAKED register_t __cdecl internal_6d9d5b0()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax], offset public_6db50ec
        mov dword ptr ds : [eax+0xC], 0x20007
        ret 
        UNREACHABLE_TRAP(0x6d9d5b0)
    }
}
