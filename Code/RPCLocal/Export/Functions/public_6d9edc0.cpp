...
PROC_DECLARE(0x6d9edc0, internal_6d9edc0, public_6d9edc0);
extern "C" NAKED register_t __cdecl internal_6d9edc0()
{
    __asm
    {
        push ecx
        ...
        mov dword ptr ds : [eax], offset public_6db4018
