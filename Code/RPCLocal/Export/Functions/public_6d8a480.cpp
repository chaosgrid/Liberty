...
#define public_6d8a5b3 _public_6d8a5b3

PROC_DECLARE(0x6d8a480, internal_6d8a480, public_6d8a480);
extern "C" NAKED register_t __cdecl internal_6d8a480()
{
    __asm
    {
        push ecx
        ...
        pop ecx
        ret 8
        UNREACHABLE_TRAP(0x6d8a480)
    }
}

#undef public_6d8a5b3
