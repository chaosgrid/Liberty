...
PROC_DECLARE(0x6d9e8b0, internal_6d9e8b0, public_6d9e8b0);
extern "C" NAKED register_t __cdecl internal_6d9e8b0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6db2848 @0x6d9e8b2*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        add esp, 4
        mov dword ptr ds : [esi], offset public_6db52ac
