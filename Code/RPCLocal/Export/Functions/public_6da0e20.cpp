...
PROC_DECLARE(0x6da0e20, internal_6da0e20, public_6da0e20);
extern "C" NAKED register_t __cdecl internal_6da0e20()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax], offset public_6db5d54
        mov dword ptr ds : [eax+0xC], 0x30022
        ret 
        UNREACHABLE_TRAP(0x6da0e20)
    }
}
