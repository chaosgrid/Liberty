...
CLANG_FORWARD_PROC_SYMBOL(public_6d84100);

PROC_DECLARE(0x6d84100, internal_6d84100, public_6d84100);
extern "C" NAKED register_t __cdecl internal_6d84100()
{
    __asm
    {
        mov eax, ecx
        ...
        mov byte ptr ds : [eax+0x8D], cl
        mov byte ptr ds : [eax+0x8E], cl
        mov byte ptr ds : [eax+0x8F], cl
        mov byte ptr ds : [eax+0x90], cl
        ret 
        UNREACHABLE_TRAP(0x6d84100)
    }
}
