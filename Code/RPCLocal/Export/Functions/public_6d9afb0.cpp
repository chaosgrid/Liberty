...
PROC_DECLARE(0x6d9afb0, internal_6d9afb0, public_6d9afb0);
extern "C" NAKED register_t __cdecl internal_6d9afb0()
{
    __asm
    {
        push ecx
        ...
        mov dword ptr ds : [eax], offset public_6db4388
        mov dword ptr ds : [eax+0xC], 0x10002
        pop ecx
        ret 
        UNREACHABLE_TRAP(0x6d9afb0)
    }
}
