...
#define public_6d8a267 _public_6d8a267

PROC_DECLARE(0x6d8a180, internal_6d8a180, public_6d8a180);
extern "C" NAKED register_t __cdecl internal_6d8a180()
{
    __asm
    {
        push ecx
        ...
        pop ecx
        ret 8
        UNREACHABLE_TRAP(0x6d8a180)
    }
}

#undef public_6d8a267
