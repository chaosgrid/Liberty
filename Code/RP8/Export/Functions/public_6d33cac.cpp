...
PROC_DECLARE(0x6d33cac, internal_6d33cac, public_6d33cac);
extern "C" NAKED register_t __cdecl internal_6d33cac()
{
    __asm
    {
        ...
        push ecx
        push esi
        call dword ptr ds : [public_6d6c938]
        add esp, 0x18
        pop esi
        ret 
        UNREACHABLE_TRAP(0x6d33cac)
    }
}
