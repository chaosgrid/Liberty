...
CLANG_FORWARD_PROC_SYMBOL(public_6d4fcf0);

PROC_DECLARE(0x6d4fcf0, internal_6d4fcf0, public_6d4fcf0);
extern "C" NAKED register_t __cdecl internal_6d4fcf0()
{
    __asm
    {
        push ebp
