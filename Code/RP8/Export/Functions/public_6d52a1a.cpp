...
CLANG_FORWARD_PROC_SYMBOL(public_6d52a1a);

PROC_DECLARE(0x6d52a1a, internal_6d52a1a, public_6d52a1a);
extern "C" NAKED register_t __cdecl internal_6d52a1a()
{
    __asm
    {
        femms 
        ...
        movq mm4, mm0
        movq mm5, mm1
        pfmul mm0, mmword ptr ss : [esp]
        pfmul mm1, mmword ptr ss : [esp+8]
        movq mm6, mm2
        movq mm7, mm3
        pfmul mm2, mmword ptr ss : [esp+0x10]
        pfmul mm3, mmword ptr ss : [esp+0x18]
        pfmul mm4, mmword ptr ss : [esp+0x20]
        pfmul mm5, mmword ptr ss : [esp+0x28]
        pfmul mm6, mmword ptr ss : [esp+0x30]
        pfmul mm7, mmword ptr ss : [esp+0x38]
        pfacc mm0, mm2
        pfacc mm1, mm3
        pfacc mm4, mm6
        pfacc mm5, mm7
