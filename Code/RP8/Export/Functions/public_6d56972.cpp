...
CLANG_FORWARD_PROC_SYMBOL(public_6d56972);

PROC_DECLARE(0x6d56972, internal_6d56972, public_6d56972);
extern "C" NAKED register_t __cdecl internal_6d56972()
{
    __asm
    {
        femms 
        ...
        movd dword ptr ds : [eax+8], mm0
        femms 
        ret 0x18
        UNREACHABLE_TRAP(0x6d56972)
    }
}
