...
CLANG_FORWARD_PROC_SYMBOL(public_6d513e0);
CLANG_FORWARD_PROC_SYMBOL(public_6d592a0);

#define public_6d513f1 _public_6d513f1

PROC_DECLARE(0x6d513e0, internal_6d513e0, public_6d513e0);
extern "C" NAKED register_t __cdecl internal_6d513e0()
{
    __asm
    {
        push ebx
        ...
        movss xmm2, dword ptr ds : [public_6d752c0]
        unpcklps xmm0, xmm1
        ...
        mulps xmm0, xmmword ptr ds : [public_6d752b0]
        ...
        xorps xmm0, xmmword ptr ds : [public_6d752a0]
        addps xmm1, xmm0
        movaps xmmword ptr ss : [esp+0x10], xmm1
        ...
        pop ebx
        ret 0x10
        UNREACHABLE_TRAP(0x6d513e0)
    }
}

#undef public_6d513f1
