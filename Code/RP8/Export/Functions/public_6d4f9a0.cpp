...
CLANG_FORWARD_PROC_SYMBOL(public_6d4f9a0);

#define public_6d4f9b1 _public_6d4f9b1

PROC_DECLARE(0x6d4f9a0, internal_6d4f9a0, public_6d4f9a0);
extern "C" NAKED register_t __cdecl internal_6d4f9a0()
{
    __asm
    {
        push ebx
        ...
        mulps xmm1, xmm5
        addps xmm3, xmm1
        xorps xmm3, xmmword ptr ds : [public_6d6e460]
        ...
        pop ebx
        ret 0x10
        UNREACHABLE_TRAP(0x6d4f9a0)
    }
}

#undef public_6d4f9b1
