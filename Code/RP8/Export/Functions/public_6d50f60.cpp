...
CLANG_FORWARD_PROC_SYMBOL(public_6d50f60);

#define public_6d50f71 _public_6d50f71

PROC_DECLARE(0x6d50f60, internal_6d50f60, public_6d50f60);
extern "C" NAKED register_t __cdecl internal_6d50f60()
{
    __asm
    {
        push ebx
        ...
        movaps xmm4, xmm3
        subps xmm3, xmm2
        movaps xmm2, xmmword ptr ds : [public_6d6e680]
        movaps xmm5, xmm3
        shufps xmm3, xmm3, 0x63
        shufps xmm5, xmm5, 0x78
        mulps xmm0, xmm3
        mulps xmm5, xmm1
        movaps xmm1, xmmword ptr ds : [public_6d6e690]
        subps xmm0, xmm5
        ...
        addss xmm6, xmm4
        addss xmm0, xmm6
        xorps xmm0, xmmword ptr ds : [public_6d6e670]
        ...
        pop ebx
        ret 0x10
        UNREACHABLE_TRAP(0x6d50f60)
    }
}

#undef public_6d50f71
