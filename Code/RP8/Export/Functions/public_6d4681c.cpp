...
#define public_6d46844 _public_6d46844

PROC_DECLARE(0x6d4681c, internal_6d4681c, public_6d4681c);
extern "C" NAKED register_t __cdecl internal_6d4681c()
{
    __asm
    {
        push ebp
        ...
        pop ebp
        ret 
        UNREACHABLE_TRAP(0x6d4681c)
    }
}

#undef public_6d46844
