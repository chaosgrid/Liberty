...
CLANG_FORWARD_PROC_SYMBOL(public_6d4ff90);

PROC_DECLARE(0x6d4ff90, internal_6d4ff90, public_6d4ff90);
extern "C" NAKED register_t __cdecl internal_6d4ff90()
{
    __asm
    {
        push ebp
