...
CLANG_FORWARD_PROC_SYMBOL(public_6d56a46);

PROC_DECLARE(0x6d56a46, internal_6d56a46, public_6d56a46);
extern "C" NAKED register_t __cdecl internal_6d56a46()
{
    __asm
    {
        ...
        movd mm7, dword ptr ds : [ecx+8]
        pfmul mm5, mm7
        pfadd mm0, mm1
        movd mm7, dword ptr ds : [eax+8]
        pfmul mm6, mm7
        mov eax, dword ptr ss : [esp+4]
        pfadd mm4, mm5
        movq mm7, mm3
        movd mm5, dword ptr ds : [edx+8]
        pfadd mm0, mm2
        ...
        pfmul mm4, mm1
        movd dword ptr ds : [eax+8], mm4
        femms 
        ret 0x18
        UNREACHABLE_TRAP(0x6d56a46)
    }
}
