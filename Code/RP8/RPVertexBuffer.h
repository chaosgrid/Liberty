...
struct DACOM_NO_VTABLE IRPVertexBuffer : public IDAComponent
{
	...
	DACOM_DEFMETHOD(create_vb)(UNKNOWN format, U32 count, IRP_VERTEXBUFFERHANDLE* out_vbhandle, BYTE flags);
	DACOM_DEFMETHOD(destroy_vb)(IRP_VERTEXBUFFERHANDLE vbhandle);
	DACOM_DEFMETHOD(ressize_vb)(IRP_VERTEXBUFFERHANDLE vbhandle, UNKNOWN format, U32 count);
	DACOM_DEFMETHOD(copy_vertices)(IRP_VERTEXBUFFERHANDLE vbhandle, U32* offset, UNKNOWN* a4, UNKNOWN a5, UNKNOWN a6);
