...
class COMMON_DEC NullNode
{
    public:
        ...
        virtual void Getstruct VisualSize(const TextRenderContext&, struct struct VisualSize&) const;
...
class COMMON_DEC StyleNode
{
    public:
        ...
        virtual void GetElementSize(int &)const ;
        virtual void Getstruct VisualSize(class TextRenderContext const &,struct struct VisualSize &)const ;
...
class COMMON_DEC TextPtrNode
{
    public:
        ...
        virtual void GetElementPos(int, TextRenderContext&, int&) const;
        virtual void GetElementSize(int&) const;
        virtual void Getstruct VisualSize(const TextRenderContext&, struct VisualSize&) const;
        virtual bool SplitAtSize(const TextRenderContext&, int, unsigned int, RDLNode*&, RDLNode*&) const;
        virtual void Update(float);
