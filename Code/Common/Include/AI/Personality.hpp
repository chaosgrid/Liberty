...
namespace pub
{
    namespace AI
    {
        class Personality
        {
            ...
            {
                    COMMON_DEC EvadeDodgeUseStruct();
                    COMMON_DEC EvadeDodgeUseStruct& operator=(const EvadeDodgeUseStruct&);
            ...
            {
                    COMMON_DEC EvadeBreakUseStruct();
                    COMMON_DEC EvadeBreakUseStruct& operator=(const EvadeBreakUseStruct&);
            ...
            {
                    COMMON_DEC BuzzHeadTowardUseStruct();
                    COMMON_DEC BuzzHeadTowardUseStruct& operator=(const BuzzHeadTowardUseStruct&);
            ...
            {
                    COMMON_DEC BuzzPassByUseStruct();
                    COMMON_DEC BuzzPassByUseStruct& operator=(const BuzzPassByUseStruct&);
            ...
            {
                    COMMON_DEC TrailUseStruct();
                    COMMON_DEC TrailUseStruct& operator=(const TrailUseStruct&);
            ...
            {
                    COMMON_DEC StrafeUseStruct();
                    COMMON_DEC StrafeUseStruct& operator=(const StrafeUseStruct&);
            ...
            {
                    COMMON_DEC EngineKillUseStruct();
                    COMMON_DEC EngineKillUseStruct& operator=(const EngineKillUseStruct&);
            ...
            {
                    COMMON_DEC RepairUseStruct();
                    COMMON_DEC RepairUseStruct& operator=(const RepairUseStruct&);
            ...
            struct GunUseStruct
            {
                    COMMON_DEC GunUseStruct();
                    COMMON_DEC GunUseStruct& operator=(const GunUseStruct&);
            ...
            {
                    COMMON_DEC MineUseStruct();
                    COMMON_DEC MineUseStruct& operator=(const MineUseStruct&);
            ...
            {
                    COMMON_DEC MissileUseStruct();
                    COMMON_DEC MissileUseStruct& operator=(const MissileUseStruct&);
            ...
            {
                    COMMON_DEC DamageReactionStruct();
                    COMMON_DEC DamageReactionStruct& operator=(const DamageReactionStruct&);
            ...
            {
                    COMMON_DEC MissileReactionStruct();
                    COMMON_DEC MissileReactionStruct& operator=(const MissileReactionStruct&);
            ...
            {
                    COMMON_DEC CountermeasureUseStruct();
                    COMMON_DEC CountermeasureUseStruct& operator=(const CountermeasureUseStruct&);
            ...
            {
                    COMMON_DEC FormationUseStruct();
                    COMMON_DEC FormationUseStruct& operator=(const FormationUseStruct&);
            ...
            struct JobStruct
            {
                    COMMON_DEC JobStruct();
                    COMMON_DEC JobStruct& operator=(const JobStruct&);
            ...
            COMMON_DEC Personality();
            COMMON_DEC Personality& operator=(const Personality&);
            COMMON_DEC static const float SCAN_CHANCE_DEFAULT;
            COMMON_DEC float get_range_threshold_value();
            COMMON_DEC float get_toughness_ratio(TOUGHNESS_TYPE);
