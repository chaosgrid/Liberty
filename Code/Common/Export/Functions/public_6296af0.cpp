...
PROC_DECLARE(0x6296af0, internal_6296af0, public_6296af0);
extern "C" NAKED register_t __cdecl internal_6296af0()
{
    __asm
    {
        push esi
        ...
        rep movsd
        pop edi
        mov dword ptr ds : [eax], offset public_639cfac
        pop esi
        ret 4
        UNREACHABLE_TRAP(0x6296af0)
    }
}
