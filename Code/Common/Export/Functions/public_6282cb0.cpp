...
CLANG_FORWARD_JUMP_SYMBOL(public_6392f22);

#define public_6282d29 _public_6282d29

PROC_DECLARE(0x6282cb0, internal_6282cb0, public_6282cb0);
extern "C" NAKED register_t __cdecl internal_6282cb0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6392f22 @0x6282cb2*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_6392f22
...
/*FIXUP push offset public_63ab218 @0x6282d79*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_63ab218
        ...
        pop ebp
        pop ebx
        UNREACHABLE_TRAP(0x6282cb0)
    }
}

#undef public_6282d29
