...
CLANG_FORWARD_PROC_SYMBOL(public_62f6010);
CLANG_FORWARD_PROC_SYMBOL(public_6333e30);
CLANG_FORWARD_PROC_SYMBOL(public_6333e40);
CLANG_FORWARD_JUMP_SYMBOL(public_6395848);

PROC_DECLARE(0x62f6010, internal_62f6010, public_62f6010);
extern "C" NAKED register_t __cdecl internal_62f6010()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6395848 @0x62f6012*/
  FIXUP push esp
  FIXUP push esp
