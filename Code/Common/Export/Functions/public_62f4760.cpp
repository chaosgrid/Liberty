...
CLANG_FORWARD_PROC_SYMBOL(public_62f4760);
CLANG_FORWARD_PROC_SYMBOL(public_6333e40);
CLANG_FORWARD_JUMP_SYMBOL(public_6395818);

PROC_DECLARE(0x62f4760, internal_62f4760, public_62f4760);
extern "C" NAKED register_t __cdecl internal_62f4760()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6395818 @0x62f4762*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [esi], offset public_63998f4
        pop edi
        mov eax, esi
        pop esi
