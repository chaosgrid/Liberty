...
CLANG_FORWARD_JUMP_SYMBOL(public_6392573);

PROC_DECLARE(0x6265450, internal_6265450, public_6265450);
extern "C" NAKED register_t __cdecl internal_6265450()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6392573 @0x6265452*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_6392573
