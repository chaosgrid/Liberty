...
CLANG_FORWARD_PROC_SYMBOL(public_62f6bf0);
CLANG_FORWARD_PROC_SYMBOL(public_6333e30);
CLANG_FORWARD_PROC_SYMBOL(public_6333e40);
CLANG_FORWARD_JUMP_SYMBOL(public_6395848);

PROC_DECLARE(0x62f6bf0, internal_62f6bf0, public_62f6bf0);
extern "C" NAKED register_t __cdecl internal_62f6bf0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6395848 @0x62f6bf2*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        pop edi
        mov dword ptr ds : [esi], offset public_6399c90
        mov eax, esi
        pop esi
        pop ebx
