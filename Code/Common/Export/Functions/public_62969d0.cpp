...
PROC_DECLARE(0x62969d0, internal_62969d0, public_62969d0);
extern "C" NAKED register_t __cdecl internal_62969d0()
{
    __asm
    {
        push esi
        ...
        rep movsd
        pop edi
        mov dword ptr ds : [eax], offset public_639cee4
        pop esi
        ret 4
        UNREACHABLE_TRAP(0x62969d0)
    }
}
