...
CLANG_FORWARD_PROC_SYMBOL(public_62f7970);
CLANG_FORWARD_PROC_SYMBOL(public_6333e40);
CLANG_FORWARD_JUMP_SYMBOL(public_6395818);

PROC_DECLARE(0x62f7970, internal_62f7970, public_62f7970);
extern "C" NAKED register_t __cdecl internal_62f7970()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6395818 @0x62f7972*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [esi], offset public_6399d40
