...
#define public_6268ed9 _public_6268ed9

PROC_DECLARE(0x6268e60, internal_6268e60, public_6268e60);
extern "C" NAKED register_t __cdecl internal_6268e60()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6392672 @0x6268e62*/
  FIXUP push esp
  FIXUP push esp
...
/*FIXUP push offset public_63ab218 @0x6268f29*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_63ab218
        ...
        pop ebp
        pop ebx
        UNREACHABLE_TRAP(0x6268e60)
    }
}

#undef public_6268ed9
