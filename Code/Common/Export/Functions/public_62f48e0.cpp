...
CLANG_FORWARD_PROC_SYMBOL(public_62f48e0);
CLANG_FORWARD_PROC_SYMBOL(public_6333e40);
CLANG_FORWARD_JUMP_SYMBOL(public_6395818);

PROC_DECLARE(0x62f48e0, internal_62f48e0, public_62f48e0);
extern "C" NAKED register_t __cdecl internal_62f48e0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6395818 @0x62f48e2*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [esi+0x74], 0x447A0000
        mov dword ptr ds : [esi], offset public_6399920
        pop edi
        mov eax, esi
        pop esi
