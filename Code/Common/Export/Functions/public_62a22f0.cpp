...
CLANG_FORWARD_JUMP_SYMBOL(public_6393c74);

#define public_62a23b5 _public_62a23b5

PROC_DECLARE(0x62a22f0, internal_62a22f0, public_62a22f0);
extern "C" NAKED register_t __cdecl internal_62a22f0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6393c74 @0x62a22f2*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_6393c74
  ...
  FIXUP pop eax
        ...
        mov al, byte ptr ss : [ebp+0xF0]
        mov byte ptr ds : [ebx+0xF0], al
        mov cl, byte ptr ss : [ebp+0xF1]
        mov byte ptr ds : [ebx+0xF1], cl
        ...
        pop esi
        mov dword ptr ds : [ebx+0xF8], eax
        mov dword ptr ds : [ebx], offset public_639db94
        pop ebp
        mov eax, ebx
        pop ebx
        ...
        add esp, 0x10
        ret 4
        UNREACHABLE_TRAP(0x62a22f0)
    }
}

#undef public_62a23b5
