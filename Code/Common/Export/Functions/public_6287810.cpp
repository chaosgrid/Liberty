...
PROC_DECLARE(0x6287810, internal_6287810, public_6287810);
extern "C" NAKED register_t __cdecl internal_6287810()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax], offset public_639bf7c
        pop esi
        ret 4
        UNREACHABLE_TRAP(0x6287810)
    }
}
