...
CLANG_FORWARD_PROC_SYMBOL(public_62f5e90);
CLANG_FORWARD_PROC_SYMBOL(public_6333e30);
CLANG_FORWARD_PROC_SYMBOL(public_6333e40);
CLANG_FORWARD_JUMP_SYMBOL(public_6395800);

PROC_DECLARE(0x62f5e90, internal_62f5e90, public_62f5e90);
extern "C" NAKED register_t __cdecl internal_62f5e90()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6395800 @0x62f5e92*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        pop edi
        mov dword ptr ds : [esi], offset public_6399be0
        mov eax, esi
        pop esi
        pop ebx
