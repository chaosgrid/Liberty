...
PROC_DECLARE(0x62928f0, internal_62928f0, public_62928f0);
extern "C" NAKED register_t __cdecl internal_62928f0()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax], offset public_639c51c
        ret 4
        UNREACHABLE_TRAP(0x62928f0)
    }
}
