...
PROC_DECLARE(0x62950b0, internal_62950b0, public_62950b0);
extern "C" NAKED register_t __cdecl internal_62950b0()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax], offset public_639cc4c
        ret 4
        UNREACHABLE_TRAP(0x62950b0)
    }
}
