...
CLANG_FORWARD_PROC_SYMBOL(public_62f4a30);
CLANG_FORWARD_PROC_SYMBOL(public_6333e40);
CLANG_FORWARD_JUMP_SYMBOL(public_6395818);

PROC_DECLARE(0x62f4a30, internal_62f4a30, public_62f4a30);
extern "C" NAKED register_t __cdecl internal_62f4a30()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6395818 @0x62f4a32*/
  FIXUP push esp
  FIXUP push esp
