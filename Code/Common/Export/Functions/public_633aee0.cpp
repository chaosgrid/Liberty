...
CLANG_FORWARD_PROC_SYMBOL(public_633aee0);
CLANG_FORWARD_PROC_SYMBOL(public_6391d5a);
CLANG_FORWARD_JUMP_SYMBOL(public_6397809);

#define public_633af34 _public_633af34
#define public_633af50 _public_633af50
#define public_633af65 _public_633af65

PROC_DECLARE(0x633aee0, internal_633aee0, public_633aee0);
extern "C" NAKED register_t __cdecl internal_633aee0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6397809 @0x633aee2*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        add esp, 0x14
        ret 
        UNREACHABLE_TRAP(0x633aee0)
    }
}

#undef public_633af34
#undef public_633af50
#undef public_633af65
