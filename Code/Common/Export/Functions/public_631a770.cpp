...
CLANG_FORWARD_JUMP_SYMBOL(public_6396a71);

PROC_DECLARE(0x631a770, internal_631a770, public_631a770);
extern "C" NAKED register_t __cdecl internal_631a770()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6396a71 @0x631a772*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_6396a71
