...
CLANG_FORWARD_PROC_SYMBOL(public_62f6b10);
CLANG_FORWARD_PROC_SYMBOL(public_6333e30);
CLANG_FORWARD_PROC_SYMBOL(public_6333e40);
CLANG_FORWARD_JUMP_SYMBOL(public_6395848);

PROC_DECLARE(0x62f6b10, internal_62f6b10, public_62f6b10);
extern "C" NAKED register_t __cdecl internal_62f6b10()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6395848 @0x62f6b12*/
  FIXUP push esp
  FIXUP push esp
