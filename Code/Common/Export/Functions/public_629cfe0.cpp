...
PROC_DECLARE(0x629cfe0, internal_629cfe0, public_629cfe0);
extern "C" NAKED register_t __cdecl internal_629cfe0()
{
    __asm
    {
        push esi
        ...
        mov dword ptr ds : [eax+0x4C], offset public_639b62c
        ...
        mov dword ptr ds : [eax+0x4C], offset public_639b60c
        mov dword ptr ds : [eax+0x58], edx
        mov dl, byte ptr ds : [ecx+0x5C]
        mov byte ptr ds : [eax+0x5C], dl
        mov dword ptr ds : [eax+0x4C], offset public_639be28
        mov cl, byte ptr ds : [ecx+0x60]
        pop edi
        mov byte ptr ds : [eax+0x60], cl
        mov dword ptr ds : [eax], offset public_639d744
        mov dword ptr ds : [eax+0x4C], offset public_639d710
        pop esi
        ret 4
        UNREACHABLE_TRAP(0x629cfe0)
    }
}
