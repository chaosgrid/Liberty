...
CLANG_FORWARD_PROC_SYMBOL(public_62f4460);
CLANG_FORWARD_PROC_SYMBOL(public_6333e40);
CLANG_FORWARD_JUMP_SYMBOL(public_6395818);

PROC_DECLARE(0x62f4460, internal_62f4460, public_62f4460);
extern "C" NAKED register_t __cdecl internal_62f4460()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6395818 @0x62f4462*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [esi], offset public_639989c
