...
#define public_62a86bb _public_62a86bb

PROC_DECLARE(0x62a85a0, internal_62a85a0, public_62a85a0);
extern "C" NAKED register_t __cdecl internal_62a85a0()
{
    __asm
    {
        sub esp, 0x70
        ...
        mov eax, dword ptr ds : [public_63fc2d4]
        ...
        jne public_62a86bb
        call public_6391cf0
        mov dword ptr ds : [public_63fc2d4], eax
        public_62a86bb : nop
        ...
        add esp, 0x70
        ret 8
        UNREACHABLE_TRAP(0x62a85a0)
    }
}

#undef public_62a86bb
