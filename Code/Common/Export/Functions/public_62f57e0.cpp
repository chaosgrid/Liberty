...
CLANG_FORWARD_PROC_SYMBOL(public_62f57e0);
CLANG_FORWARD_PROC_SYMBOL(public_6333e30);
CLANG_FORWARD_PROC_SYMBOL(public_6333e40);
CLANG_FORWARD_JUMP_SYMBOL(public_6395800);

PROC_DECLARE(0x62f57e0, internal_62f57e0, public_62f57e0);
extern "C" NAKED register_t __cdecl internal_62f57e0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6395800 @0x62f57e2*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        pop edi
        mov dword ptr ds : [esi], offset public_6399b88
        mov eax, esi
        pop esi
        pop ebx
