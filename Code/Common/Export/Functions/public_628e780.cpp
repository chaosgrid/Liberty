...
CLANG_FORWARD_JUMP_SYMBOL(public_6393522);

#define public_628e7f9 _public_628e7f9

PROC_DECLARE(0x628e780, internal_628e780, public_628e780);
extern "C" NAKED register_t __cdecl internal_628e780()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6393522 @0x628e782*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_6393522
...
/*FIXUP push offset public_63ab218 @0x628e849*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_63ab218
        ...
        pop ebp
        pop ebx
        UNREACHABLE_TRAP(0x628e780)
    }
}

#undef public_628e7f9
