...
PROC_DECLARE(0x6294e00, internal_6294e00, public_6294e00);
extern "C" NAKED register_t __cdecl internal_6294e00()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax], offset public_639cb2c
        ret 4
        UNREACHABLE_TRAP(0x6294e00)
    }
}
