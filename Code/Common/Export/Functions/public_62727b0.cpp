...
CLANG_FORWARD_JUMP_SYMBOL(public_63928c2);

#define public_6272829 _public_6272829

PROC_DECLARE(0x62727b0, internal_62727b0, public_62727b0);
extern "C" NAKED register_t __cdecl internal_62727b0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_63928c2 @0x62727b2*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_63928c2
...
/*FIXUP push offset public_63ab218 @0x6272879*/
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], offset public_63ab218
        ...
        pop ebp
        pop ebx
        UNREACHABLE_TRAP(0x62727b0)
    }
}

#undef public_6272829
