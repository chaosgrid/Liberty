...
PROC_DECLARE(0x62f3e30, internal_62f3e30, public_62f3e30);
extern "C" NAKED register_t __cdecl internal_62f3e30()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6395818 @0x62f3e32*/
  FIXUP push esp
  FIXUP push esp
