...
PROC_DECLARE(0x6295270, internal_6295270, public_6295270);
extern "C" NAKED register_t __cdecl internal_6295270()
{
    __asm
    {
        push esi
        ...
        mov dword ptr ds : [eax], offset public_639ccb4
        pop esi
        ret 4
        UNREACHABLE_TRAP(0x6295270)
    }
}
