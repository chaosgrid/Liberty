...
PROC_DECLARE(0x62929b0, internal_62929b0, public_62929b0);
extern "C" NAKED register_t __cdecl internal_62929b0()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax], offset public_639c59c
        ret 4
        UNREACHABLE_TRAP(0x62929b0)
    }
}
