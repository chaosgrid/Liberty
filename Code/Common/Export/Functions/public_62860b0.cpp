...
#define public_6286175 _public_6286175

PROC_DECLARE(0x62860b0, internal_62860b0, public_62860b0);
extern "C" NAKED register_t __cdecl internal_62860b0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6393064 @0x62860b2*/
  FIXUP push esp
  FIXUP push esp
  ...
  FIXUP pop eax
        ...
        mov dword ptr ds : [ebx], offset public_639bb0c
        pop ebp
        mov eax, ebx
        pop ebx
        ...
        add esp, 0x10
        ret 4
        UNREACHABLE_TRAP(0x62860b0)
    }
}

#undef public_6286175
