...
PROC_DECLARE(0x6294a90, internal_6294a90, public_6294a90);
extern "C" NAKED register_t __cdecl internal_6294a90()
{
    __asm
    {
        mov eax, ecx
        ...
        mov dword ptr ds : [eax], offset public_639ca64
        ret 4
        UNREACHABLE_TRAP(0x6294a90)
    }
}
