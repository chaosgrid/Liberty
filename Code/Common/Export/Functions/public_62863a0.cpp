...
PROC_DECLARE(0x62863a0, internal_62863a0, public_62863a0);
extern "C" NAKED register_t __cdecl internal_62863a0()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6393064 @0x62863a2*/
  FIXUP push esp
  FIXUP push esp
