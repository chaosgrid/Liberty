...
CLANG_FORWARD_JUMP_SYMBOL(public_6394124);

PROC_DECLARE(0x62ac790, internal_62ac790, public_62ac790);
extern "C" NAKED register_t __cdecl internal_62ac790()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6394124 @0x62ac792*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_6394124
  ...
  FIXUP pop eax
        ...
        pop esi
        mov dword ptr ds : [ebx], offset public_639e45c
        pop ebp
        mov eax, ebx
        pop ebx
