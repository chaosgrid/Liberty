...
CLANG_FORWARD_JUMP_SYMBOL(public_6392cb6);

#define public_627cec3 _public_627cec3
#define public_627ced8 _public_627ced8
#define public_627cee0 _public_627cee0
#define public_627cf00 _public_627cf00
#define public_627cf1c _public_627cf1c
#define public_627cf26 _public_627cf26
#define public_627cf70 _public_627cf70
#define public_627cf8d _public_627cf8d

PROC_DECLARE(0x627ce00, internal_627ce00, public_627ce00);
extern "C" NAKED register_t __cdecl internal_627ce00()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6392cb6 @0x627ce02*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_6392cb6
  ...
  FIXUP pop eax
        ...
        add esp, 0x1C
        ret 4
        UNREACHABLE_TRAP(0x627ce00)
    }
}

#undef public_627cec3
#undef public_627ced8
#undef public_627cee0
#undef public_627cf00
#undef public_627cf1c
#undef public_627cf26
#undef public_627cf70
#undef public_627cf8d
