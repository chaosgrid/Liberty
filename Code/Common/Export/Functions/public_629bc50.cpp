...
PROC_DECLARE(0x629bc50, internal_629bc50, public_629bc50);
extern "C" NAKED register_t __cdecl internal_629bc50()
{
    __asm
    {
        push esi
        ...
        mov dword ptr ds : [eax], offset public_639d5a4
        pop esi
        ret 4
        UNREACHABLE_TRAP(0x629bc50)
    }
}
