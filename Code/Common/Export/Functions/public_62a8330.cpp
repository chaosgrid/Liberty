...
CLANG_FORWARD_JUMP_SYMBOL(public_6393ef4);

PROC_DECLARE(0x62a8330, internal_62a8330, public_62a8330);
extern "C" NAKED register_t __cdecl internal_62a8330()
{
    __asm
    {
        push 0xFFFFFFFF
/*FIXUP push public_6393ef4 @0x62a8332*/
  FIXUP push esp
  FIXUP push esp
  FIXUP mov dword ptr ds : [esp], eax
  FIXUP mov eax, public_6393ef4
  ...
  FIXUP pop eax
        ...
        pop esi
        mov dword ptr ds : [ebx], offset public_639e014
        pop ebp
        mov eax, ebx
        pop ebx
